...
const MarqueeItem = ({desc_1 , desc_2 , stack_1, stack_2, stack_3, cssFilters} : any) => {
  return (
    <>
          <section className="relative  bg-blue-300 ml-10 w-[273px] h-[340px]  rounded-[24px] " >
            ...
            <article className='absolute bottom-4 left-4 text-white text-[13px] flex gap-1 flex-col '>
                ...
                <div className='flex w-full flex-row gap-2 text-[12px] font-[400]'>
                  <div className='border-[1px] border-neutral-50/30 rounded-full px-[8px] py-[4px]'> {stack_1} </div>
                  <div className='border-[1px] border-neutral-50/30 rounded-full px-[8px] py-[4px]'> {stack_2} </div>
