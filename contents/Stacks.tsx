    ...
    <>
      {stacks && stacks.length > 0 ? (
        <div className="relative leftMoveIconGlobalCSS ">
          ...
          <span className="flex  items-center mt-[1.1em] widthStackGlobalCSS ml-[-6px] flex-wrap ">
            {stacks.map((item: string, index: number) => {
              return (
                <span
                  ...
                  className="colorIconDescglabalCSS shrink-0 font-light text-neutral-50  px-[8px] py-[4px] rounded-[50px] text-[12px] ml-2"
                >
                  {item.trim()}
                </span>
              );
