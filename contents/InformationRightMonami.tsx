      ...
      <div className="absolute leftMoveGlobalCSS  shadow  h-fit shrink-0 rounded-[24px] bg-white p-10 flex gap-5 flex-col">
        ...
        <div className="flex justify-between">
          ...
          <span className="text-[14px]">
            {projectMonami[0].informationSection.projectName}
          </span>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <span className="text-[14px]">
            {projectMonami[0].informationSection.startDate} - {projectMonami[0].informationSection.endDate}
          </span>
        </div>
        ...
        <div className="flex justify-between">
          <a
            className="text-[14px]"
            href={projectMonami[0].informationSection.projectRepository}
          >
            <span className="text-gray-600 text-[14px]">프로젝트 깃 주소</span>
            <span className="text-[14px] flex  ">
              {projectMonami[0].informationSection.projectRepository.split('projects')[0]}
            </span>
          </a>
        </div>
        ...
        <div className="flex justify-between">
          <a
            className="text-[14px]"
            href={projectMonami[0].informationSection.projectDocuments}
          >
            <span className="text-gray-600 text-[14px]">프로젝트 관리</span>
            <span className="text-[14px] flex ">
              {`notion.site/${projectMonami[0].informationSection.projectName}`}
            </span>
          </a>
        </div>

        <div className="flex justify-between">
          <a className="text-[14px] " href={projectMonami[0].informationSection.DEVBlog}>
            <span className="text-gray-600 text-[14px]"> 딥다이브 블로그</span>
            <span className="text-[14px] flex ">
              {projectMonami[0].informationSection.DEVBlog}
            </span>
          </a>
        </div>

        <div className="flex justify-between">
          <a className="text-[14px] " href={projectMonami[0].informationSection.justStudyBlog}>
            <span className="text-gray-600 text-[14px]"> 공부기록 블로그</span>
            <span className="text-[14px] flex ">
              {projectMonami[0].informationSection.justStudyBlog}
            </span>
          </a>
        </div>
...
export default InformationRightMonami;
