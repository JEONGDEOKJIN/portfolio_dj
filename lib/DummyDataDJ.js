export const dummyProjectSTO = [
  {
    ...
    myRole: "어드민 페이지(FE, 어드민 기여도 100%), UI/UX 기획(기획 기여도 100%)",
...
export const dummyNobrokerProject = [
  {
    ...
    myRole: "매물 목록 페이지 FE&BE(해당 페이지 기여도 100%), 어드민 페이지 FE&BE(해당 페이지 기여도 100%) 및 배포(배포 기여도 50%)",
...
export const dummyMonamiProject = [
  {
    ...
    myRole: "게시판 및 상세 페이지 Frontend & Backend 개발(게시판 기여도 100%)",
...
export const dummyAWAProject = [
  {
    ...
    myRole: "main 페이지의 frontend 담당(main 페이지 기여도 100%)",
...
export const dummyProjectList = [
  {
    ...
    myRoles: ["어드민 페이지(FE, 어드민 기여도 100%) ", "UI/UX 기획(기획 기여도 100%)"], // 맡은 역할
